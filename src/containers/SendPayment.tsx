  ...
  return (
    <div className="relative">
      ...
      {panelOpen && (
        <div
          ref={panelRef}
          className="absolute bottom-full left-full z-50 mt-3 mb-20 block min-w-[320px] -translate-x-[90%] translate-y-2/5 transform rounded-lg border border-[var(--border-color)] bg-[var(--secondary-bg)] p-4 transition duration-200 ease-out sm:translate-y-1/2"
        >
