  ...
  if (step.type === "home") {
    return (
      <div className="max-w-[600px] relative mx-auto my-8 p-8 bg-[var(--secondary-bg)] rounded-lg border border-[var(--border-color)]">
        ...
        {/* Trust message */}
        <div className="mt-8 p-4 bg-gradient-to-br from-[#70C7BA]/10 to-[#70C7BA]/5 border border-[#70C7BA]/20 rounded-lg">
          ...
          <p className="text-center text-xs text-gray-400 leading-relaxed max-w-md mx-auto mb-2">
            We never store your private keys or have access to your messages.
            Everything is encrypted and controlled by you.
          </p>
          <p className="text-center text-xs text-gray-400 leading-relaxed max-w-md mx-auto">
            You can even run Kasia yourself!
            <a
              href="https://github.com/K-Kluster/Kasia"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-gray-300 underline ml-1"
            >
        ...
        {/* Why Kaspa wallet message */}
        <div className="mt-4 p-4 bg-gradient-to-br from-[#B6B6B6]/10 to-[#B6B6B6]/5 border border-[#B6B6B6]/20 rounded-lg">
          <div className="flex items-center justify-center gap-2 mb-2">
