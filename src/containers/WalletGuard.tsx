...
export const WalletGuard = ({
    ...
    const getDerivationTypeDisplay = (
                        ...
                        <div key={wallet.id} className="wallet-item">
                            <div className="wallet-info">
                                ...
                                <div className="wallet-derivation">
                                    {getDerivationTypeDisplay(
                                        wallet.derivationType
                                    )}
                    ...
                    <div className="derivation-options">
                        <label className="radio-option">
                            <input
                                ...
                                onChange={(e) =>
                                    setDerivationType(
                                        e.target.value as WalletDerivationType
                                    )
                                }
                            />
                            <span>Standard (Recommended)</span>
                            <small>
                                Compatible with Kaspium and other standard
                                wallets
                            </small>
                        </label>
                        <label className="radio-option">
        ...
        return (
            <div className="wallet-guard">
                ...
                <div className="migration-info">
                    <p>
                        Migrating wallet:{' '}
                        <strong>{walletToMigrate?.name}</strong>
                    </p>
                    <p>
                        This will create a new wallet using the standard Kaspa
                        derivation path (m/44'/111111'/0') that is compatible
                        with Kaspium and other standard wallets.
                    </p>
                    <div className="warning-message">
                        ⚠️ Your original wallet will remain unchanged. You'll
                        need to transfer funds to the new wallet addresses.
                    </div>
                </div>
                <div className="form-group">
            ...
            <div className="wallet-guard">
                ...
                {step.type === 'finalizing' && step.mnemonic && (
                    <div className="mnemonic-display">
                        ...
                        <div className="warning-message">
                            ⚠️ This is the only time you will see your seed
                            phrase - back it up now!
                        </div>
                        <div className="show-phrase-toggle">
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    if (phraseElement) {
                                        phraseElement.classList.toggle(
                                            'visible',
                                            e.target.checked
                                        )
                                    }
                            ...
                            <label htmlFor="showPhrase">
                                I understand that anyone with my seed phrase can
                                access my wallet. Show seed phrase
                            </label>
                        </div>
