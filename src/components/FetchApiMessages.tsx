            ...
            try {
              ...
              for (let i = 0; i < maxKeys && !decryptionSuccess; i++) {
                try {
                  ...
                  console.log(
                    `API Messages: Failed to decrypt with receive key at index ${i}: ${e.message}`
                  );
                }
              }
              ...
              if (!decryptionSuccess) {
                for (let i = 0; i < maxKeys && !decryptionSuccess; i++) {
                  try {
                    ...
                    console.log(
                      `API Messages: Failed to decrypt with change key at index ${i}: ${e.message}`
                    );
                  }
                }
              }
              ...
              if (
                ...
                for (let i = 0; i < maxKeys && !decryptionSuccess; i++) {
                  try {
                    ...
                    console.log(
                      `API Messages: Failed to decrypt with legacy receive key at index ${i}: ${e.message}`
                    );
                  }
                }
              }
