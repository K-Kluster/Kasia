...
export const FetchApiMessages: FC<FetchApiMessagesProps> = ({ address }) => {
    ...
    const fetchAndProcessMessages = async () => {
        ...
        try {
            ...
            await Promise.allSettled(
                [...uniqueAddresses].map(async (currentAddress) => {
                    ...
                    const messageTxs = transactions.filter(
                        (tx) =>
                            tx.payload &&
                            tx.payload.startsWith('636970685f6d73673a')
                    )
                    ...
                    for (const tx of messageTxs) {
                        ...
                        console.log(
                            `API Messages: Transaction ${tx.transaction_id}:`
                        )
                        ...
                        console.log(
                            `- Determined sender address: ${senderAddress}`
                        )
                        ...
                        if (walletStore.unlockedWallet) {
                            try {
                                ...
                                console.log(
                                    `API Messages: Full payload: ${tx.payload}`
                                )
                                ...
                                const handshakePrefix =
                                    '313a68616e647368616b653a' // "1:handshake:"
                                ...
                                console.log(
                                    `API Messages: Parsed message parts:`
                                )
                                ...
                                if (!encryptedContent) {
                                    console.log(
                                        'API Messages: No encrypted content found'
                                    )
                                    continue
                                }
                                ...
                                for (
                                    ...
                                    try {
                                        ...
                                        const privateKey =
                                            privateKeyGenerator.receiveKey(i)
                                        const privateKeyHex =
                                            privateKey.toString()
                                        console.log(
                                ...
                                if (!decryptionSuccess) {
                                    for (
                                        ...
                                        try {
                                            ...
                                            const privateKey =
                                                privateKeyGenerator.changeKey(i)
                                            const privateKeyHex =
                                                privateKey.toString()
                                            console.log(
                                ...
                                if (
                                    ...
                                    const legacyKeyGenerator =
                                        new PrivateKeyGenerator(
                                            xprv,
                                            false,
                                            BigInt(1)
                                    ...
                                    for (
                                        ...
                                        try {
                                            ...
                                            const privateKey =
                                                legacyKeyGenerator.receiveKey(i)
                                            const privateKeyHex =
                                                privateKey.toString()
                                ...
                                console.error(
                                    'API Messages: Error decrypting message:',
                                    error
                                )
            ...
            console.log(
                'API Messages: Fetch and process completed successfully'
            )
        } catch (err) {
        ...
        <div>
            <button
                ...
                title={
                    error
                        ? `Error: ${error}`
                        : 'Fetch latest messages from blockchain'
                }
            >
                {loading ? (
