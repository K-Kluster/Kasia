        ...
        >
            ...
            <div style={{ marginBottom: '20px' }}>
                ...
                <ol style={{ padding: '0 0 0 20px', margin: 0 }}>
                    <li>
                        We use your wallet's private key to decrypt messages
                        sent to your address
                    </li>
                    <li>
                        The decryption process needs the ephemeral public key
                        and nonce from the encrypted message
                    </li>
                    <li>
                        A shared secret is derived using your private key and
                ...
                >
                    ...
                    <button
                        ...
                        style={{
                            ...
                            color: 'white',
                            opacity:
                                !walletStore.unlockedWallet || !encryptedHex
                                    ? '0.5'
                                    : '1',
                        }}
                    >
            ...
            >
                <h3 style={{ color: '#90cdf4', margin: '0 0 10px 0' }}>
                    Debug Log:
                </h3>
